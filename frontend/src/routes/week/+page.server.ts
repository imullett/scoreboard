import { fetchFromAPI, getCurrentWeek, matchupWeeks, type MatchupWeek } from "$lib"
...
function convertToMatchupWeek(week: number | string): MatchupWeek | ActionFailure<{ week: boolean }> {
